...
# q4
# With some code chunks, we may not want the output generated by the chunk to be rendered into HTML 
# but would prefer to print the output verbatim. 
...
# q5
# When using knitr and R Markdown and producing output in HTML, 
# why should you never edit the resulting HTML file?
